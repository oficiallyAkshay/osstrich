...
function runGet(rest, deps) {
  ...
  // eslint-disable-next-line unicorn/no-computed-property-existence-check -- checking the env var's VALUE is truthy (set and non-empty), not merely that the key exists; `Object.hasOwn` would be wrong here.
